...
\usepackage[headsepline=0.4pt, footsepline=0.4pt]{scrlayer-scrpage} 							% Aufruf KOMA-Skript für Kopfzeilen
...
%\setheadsepline{0.4pt}							% Trennlinie Fußzeile und Textkörper - DEPRICATED!!!
\setkomafont{headsepline}{\scshape}				% Schriftart in Kopfzeile, \scshape = Kapitelchen
%----Fußzeile----------------------------------------------------------------------
%\setfootsepline{0.4pt} 						% Trennlinie Fußzeile und Textkörper - DEPRICATED!!!!
